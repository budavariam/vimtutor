...
!(function (e, t) {
    "object" == typeof exports && "object" == typeof module
      ? (module.exports = t(
          ...
          require("monaco-editor/esm/vs/editor/common/commands/shiftCommand")
        ))
      : "function" == typeof define && define.amd
      ? define(
          ["vs/editor/editor.main", "vs/editor/common/commands/shiftCommand"],
          t
        )
      ...
      : (e.MonacoVim = t(e.monaco, e[void 0]));
  })(self, function (e, t) {
    return (() => {
      "use strict";
      var n = {
      ...
      return (
        (() => {
          ...
          var c = { readOnly: 65, cursorWidth: 20, fontInfo: 32 },
            u =
              /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
          function h(e, t) {
          ...
          function d(e) {
            return new h(e.lineNumber - 1, e.column - 1);
          }
          function p(t) {
            return new e.Position(t.line + 1, t.ch + 1);
          }
          f.prototype = {
            eol: function () {
          ...
          function m(t) {
            var n =
              ...
              r = !0,
              o = e.KeyCode[t.keyCode];
            t.key && ((o = t.key), (r = !1));
            var i = o,
              a = n;
            switch (t.keyCode) {
              case e.KeyCode.Shift:
              case e.KeyCode.Meta:
              case e.KeyCode.Alt:
              case e.KeyCode.Ctrl:
                return i;
            ...
            return (
              o.startsWith("Key") || o.startsWith("KEY_")
                ? (i = o[o.length - 1].toLowerCase())
                : o.startsWith("Digit")
                ? (i = o.slice(5, 6))
                : o.startsWith("Numpad")
                ? (i = o.slice(6, 7))
                : o.endsWith("Arrow")
                ? ((a = !0), (i = o.substring(0, o.length - 5)))
                : (o.startsWith("US_") || o.startsWith("Bracket") || !i) &&
                  (i = t.browserEvent.key),
              a || t.altKey || t.ctrlKey || t.metaKey
                ? (t.altKey && (i = "Alt-".concat(i)),
                  t.ctrlKey && (i = "Ctrl-".concat(i)),
                  t.metaKey && (i = "Meta-".concat(i)),
                  t.shiftKey && (i = "Shift-".concat(i)))
                : (i = t.key || t.browserEvent.key),
              1 === i.length && r && (i = "'".concat(i, "'")),
              i
            );
          }
          var v = (function () {
            function o(e) {
              a(this, o),
                ...
                (this.ctxInsert = this.editor.createContextKey("insertMode", !0));
            }
            return (
              l(o, [
                {
                ...
                },
                {
                  ...
                  value: function (t, n) {
                    ...
                    if (t.startsWith("'")) o = t[1];
                    else if ("Enter" === o) o = "\n";
                    else {
                      if ("Backspace" !== o) return;
                    ...
                    n.preventDefault(),
                      n.stopPropagation(),
                      this.replaceStack || (this.replaceStack = []),
                      r ||
                        this.replaceStack.push(
                          this.editor.getModel().getValueInRange(a)
                        ),
                      this.editor.executeEdits("vim", [
                        { text: o, range: a, forceMoveMarkers: !0 },
                      ]),
                      r && this.editor.setPosition(a.getStartPosition());
                  },
                },
                {
                  key: "setOption",
                  value: function (t, n) {
                    (this.state[t] = n), "theme" === t && e.editor.setTheme(n);
                  },
                },
                {
                  ...
                  value: function () {
                    var t = this.editor,
                      n = c;
                    return "function" == typeof t.getConfiguration
                      ? t.getConfiguration()
                      : ("EditorOption" in e.editor &&
                          (n = e.editor.EditorOption),
                        {
                          readOnly: t.getOption(n.readOnly),
                          viewInfo: { cursorWidth: t.getOption(n.cursorWidth) },
                          fontInfo: t.getOption(n.fontInfo),
                        });
                  },
                },
                {
                  ...
                  value: function (e) {
                    return "readOnly" === e
                      ? this.getConfiguration().readOnly
                      : "firstLineNumber" === e
                      ? this.firstLine() + 1
                      : "indentWithTabs" === e
                      ? !this.editor.getModel().getOptions().insertSpaces
                      : "function" == typeof this.editor.getConfiguration
                      ? this.editor.getRawConfiguration()[e]
                      : this.editor.getRawOptions()[e];
                  },
                },
                {
                  key: "dispatch",
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    n &&
                      (this.listeners[e] = n.filter(function (e) {
                        return e !== t;
                      }));
                  },
                },
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    return (
                      e + 1 > t && (e = t - 1),
                      this.editor.getModel().getLineContent(e + 1)
                    );
                  },
                },
                {
                  ...
                  value: function (t) {
                    return t.isEmpty()
                      ? t.getPosition()
                      : t.getDirection() === e.SelectionDirection.LTR
                      ? t.getStartPosition()
                      : t.getEndPosition();
                  },
                },
                  ...
                  value: function () {
                    var e =
                      arguments.length > 0 && void 0 !== arguments[0]
                        ? arguments[0]
                        : null;
                    if (!e) return d(this.editor.getPosition());
                    var t = this.editor.getSelection();
                    return d(
                      t.isEmpty()
                        ? t.getPosition()
                        : "anchor" === e
                        ? this.getAnchorForSelection(t)
                        : this.getHeadForSelection(t)
                    );
                  },
                },
                {
                  ...
                  value: function (t, n) {
                    ...
                    return this.editor
                      .getModel()
                      .getValueInRange(e.Range.fromPositions(r, o));
                  },
                },
                {
                  key: "getSelection",
                  value: function () {
                    var e = [],
                      t = this.editor;
                    return (
                      t.getSelections().map(function (n) {
                        e.push(t.getModel().getValueInRange(n));
                      }),
                      e.join("\n")
                    );
                  },
                },
                {
                  ...
                  value: function (t, n, r) {
                    var o = p(n),
                      i = r ? p(r) : o;
                    this.editor.executeEdits("vim", [
                      { text: t, range: e.Range.fromPositions(o, i) },
                    ]),
                      this.pushUndoStop();
                  },
                },
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    var n = e;
                    "object" !== r(e) && (((n = {}).line = e), (n.ch = t));
                    var o = this.editor.getModel().validatePosition(p(n));
                    this.editor.setPosition(p(n)), this.editor.revealPosition(o);
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this,
                      t = this.editor.getSelections();
                    return !t.length || this.inVirtualSelectionMode
                      ? [
                          {
                      ...
                      : t.map(function (t) {
                          return (
                            ...
                            t.getEndPosition(),
                            {
                              anchor: e.clipPos(d(e.getAnchorForSelection(t))),
                              head: e.clipPos(d(e.getHeadForSelection(t))),
                            }
                          );
                        });
                  },
                ...
                },
                {
                  key: "setSelections",
                  value: function (t, n) {
                    var r = !!this.editor.getSelections().length,
                      o = t.map(function (t, n) {
                        var o = t.anchor,
                          i = t.head;
                        return r
                          ? e.Selection.fromPositions(p(o), p(i))
                          : e.Selection.fromPositions(p(i), p(o));
                      });
                    if ((n && o[n] && o.push(o.splice(n, 1)[0]), o.length)) {
                      var i,
                        a = o[0];
                      (i =
                        a.getDirection() === e.SelectionDirection.LTR
                          ? a.getEndPosition()
                          : a.getStartPosition()),
                        this.editor.setSelections(o),
                        this.editor.revealPosition(i);
                    }
                  },
                },
                {
                  key: "setSelection",
                  value: function (t, n) {
                    var r = e.Range.fromPositions(p(t), p(n));
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this.editor;
                    return e.getSelections().map(function (t) {
                      return e.getModel().getValueInRange(t);
                    });
                  },
                },
                {
                  ...
                  value: function (e) {
                    var t = this.editor;
                    t.getSelections().forEach(function (n, r) {
                      t.executeEdits("vim", [
                        { range: n, text: e[r], forceMoveMarkers: !1 },
                      ]);
                    });
                  },
                },
                {
                  ...
                  value: function (e) {
                    e
                      ? (this.enterVimMode(), (this.replaceMode = !0))
                      : (this.leaveVimMode(),
                        (this.replaceMode = !1),
                        (this.replaceStack = []));
                  },
                },
                {
                  key: "charCoords",
                  value: function (e, t) {
                    return { top: e.line, left: e.ch };
                  },
                },
                { key: "coordsChar", value: function (e, t) {} },
                {
                  key: "clipPos",
                  value: function (e) {
                    return d(this.editor.getModel().validatePosition(p(e)));
                  },
                },
                {
                  key: "setBookmark",
                  value: function (e, t) {
                    var n = new g(this, this.$uid++, e.line, e.ch);
                    return (
                      (t && t.insertLeft) || (n.$insertRight = !0),
                      (this.marks[n.id] = n),
                      n
                    );
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    return {
                      left: 0,
                      top: o.startLineNumber - 1,
                      height: r.getModel().getLineCount(),
                      clientHeight: o.endLineNumber - o.startLineNumber + 1,
                    };
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    this.dispatch("dispose"),
                      this.removeOverlay(),
                      o.keyMap.vim && o.keyMap.vim.detach(this),
                      this.disposables.forEach(function (e) {
                        return e.dispose();
                      });
                  },
                },
                { key: "getInputField", value: function () {} },
                { key: "getWrapperElement", value: function () {} },
                {
                  key: "enterVimMode",
                  value: function () {
                    this.ctxInsert.set(!1);
                    var e = this.getConfiguration();
                    (this.initialCursorWidth = e.viewInfo.cursorWidth || 0),
                      this.editor.updateOptions({
                        cursorWidth: e.fontInfo.typicalFullwidthCharacterWidth,
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this.editor.getVisibleRanges();
                    if (!e.length) return { top: 0, bottom: 0 };
                    var t = { top: 1 / 0, bottom: 0 };
                    return (
                      e.reduce(function (e, t) {
                        return (
                          t.startLineNumber < e.top &&
                            (e.top = t.startLineNumber),
                          t.endLineNumber > e.bottom &&
                            (e.bottom = t.endLineNumber),
                          e
                        );
                      }, t),
                      (t.top -= 1),
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    var r = this.editor,
                      ...
                      a = p(e);
                    if ("page" === n) {
                      var s = r.getLayoutInfo().height,
                        l = this.getConfiguration().fontInfo.lineHeight;
                      (o *= Math.floor(s / l)), (i = "line");
                    }
                    return "line" === i && (a.lineNumber += o), d(a);
                  },
                },
                {
                  ...
                  value: function (e) {
                    var t,
                      n,
                      r = p(e),
                      o = this.editor.getModel();
                    return (t = o.bracketPairs
                      ? o.bracketPairs.matchBracket(r)
                      : null === (n = o.matchBracket) || void 0 === n
                      ? void 0
                      : n.call(o, r)) && 2 === t.length
                      ? { to: d(t[1].getStartPosition()) }
                      : { to: null };
                  },
                },
                {
                  ...
                  value: function (e) {
                    return (
                      this.editor
                        .getModel()
                        .getLineFirstNonWhitespaceColumn(e + 1) - 1
                    );
                  },
                },
                {
                  ...
                  value: function (e, t) {
                    (e || t) &&
                      (e ||
                        (t < 0 && (t = this.editor.getPosition().lineNumber - t),
                        this.editor.setScrollTop(
                          this.editor.getTopForLineNumber(t + 1)
                        )));
                  },
                },
                {
                  ...
                  value: function (t) {
                    var n,
                      r = this.editor,
                      o = r.getPosition(),
                      i = e.Range.fromPositions(o, o);
                    switch (t) {
                      case "top":
                        return void r.revealRangeAtTop(i);
                      case "center":
                        return void r.revealRangeInCenter(i);
                      case "bottom":
                        return void (
                          null === (n = r._revealRange) ||
                          void 0 === n ||
                          n.call(r, i, 4)
                        );
                    }
                  ...
                  value: function (e, t) {
                    ...
                    return {
                      ...
                      jumpTo: function (e) {
                        ...
                        return (
                          (s = t.range),
                          i.highlightRanges([s], "currentFindMatch"),
                          i.highlightRanges(
                            c
                              .map(function (e) {
                                return e.range;
                      ...
                      find: function (t) {
                        ...
                        var a;
                        if (t) {
                          var u = s ? s.getStartPosition() : o;
                          if (
                            !(a = l.findPreviousMatch(e, u, r, n)) ||
                            !a.range.getStartPosition().isBeforeOrEqual(u)
                          )
                            return !1;
                        } else {
                          var h = s
                            ? l.getPositionAt(
                                l.getOffsetAt(s.getEndPosition()) + 1
                              )
                            : o;
                          if (
                            !(a = l.findNextMatch(e, h, r, n)) ||
                            !h.isBeforeOrEqual(a.range.getStartPosition())
                          )
                            return !1;
                        }
                        return (
                      ...
                      from: function () {
                        return s && d(s.getStartPosition());
                      },
                      to: function () {
                        return s && d(s.getEndPosition());
                      },
                      replace: function (e) {
                        s &&
                          (a.executeEdits(
                            "vim",
                            [{ range: s, text: e, forceMoveMarkers: !0 }],
                            function (e) {
                              var t = e[0].range,
                                n = t.endLineNumber,
                                r = t.endColumn;
                              s = s.setEndPosition(n, r);
                            }
                          ),
                          a.setPosition(s.getStartPosition()));
                      },
                    };
                  },
                },
                      ...
                      (this[r] = this.editor.deltaDecorations(
                        ...
                        t.map(function (t) {
                          return {
                            ...
                            options: {
                              stickiness:
                                e.editor.TrackedRangeStickiness
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    ...
                    r &&
                      r instanceof RegExp &&
                      !r.global &&
                      ((i = !0), (o = !r.ignoreCase), (r = r.source));
                    var a = this.editor
                      .getModel()
                      .findNextMatch(r, this.editor.getPosition(), i, o);
                    a && a.range && this.highlightRanges([a.range]);
                  },
                },
                {
                  key: "removeOverlay",
                  value: function () {
                    var e = this;
                    ["currentFindMatch", "findMatch"].forEach(function (t) {
                      e.editor.deltaDecorations(
                        e["decoration".concat(t)] || [],
                        []
                      );
                    });
                  },
                },
                {
                  key: "scrollIntoView",
                  value: function (e) {
                    e && this.editor.revealPosition(p(e));
                  },
                },
                {
                  key: "moveH",
                  value: function (t, n) {
                    if ("char" === n) {
                      ...
                      this.editor.setPosition(
                        new e.Position(r.lineNumber, r.column + t)
                      );
                    }
                  },
                },
                {
                  ...
                  value: function (e, t, n, r) {
                    for (
                      var i = r.bracketRegex,
                        a = p(e),
                        s = this.editor.getModel(),
                        l = (
                          -1 === t ? s.findPreviousMatch : s.findNextMatch
                        ).bind(s),
                        c = [],
                        u = 0;
                      ;
                      ...
                      if (u > 10) return;
                      var h = l(i.source, a, !0, !0, null, !0),
                        f = h.matches[0];
                      if (void 0 === h) return;
                      var g = o.matchingBrackets[f];
                      if (g && (">" === g.charAt(1)) == t > 0) c.push(f);
                      else {
                        if (0 === c.length)
                          return { pos: d(h.range.getStartPosition()) };
                        c.pop();
                      }
                      (a = s.getPositionAt(
                        s.getOffsetAt(h.range.getStartPosition()) + t
                      )),
                        (u += 1);
                    }
                  },
                },
                {
                  key: "indexFromPos",
                  value: function (e) {
                    return this.editor.getModel().getOffsetAt(p(e));
                  },
                },
                {
                  key: "posFromIndex",
                  value: function (e) {
                    return d(this.editor.getModel().getPositionAt(e));
                  },
                },
                {
                  key: "indentLine",
                  value: function (n) {
                    var r,
                      ...
                      i = this.editor;
                    r = i._getViewModel
                      ? i._getViewModel().cursorConfig
                      : i._getCursors().context.config;
                    var a = new e.Position(n + 1, 1),
                      s = e.Selection.fromPositions(a, a);
                    i.executeCommand(
                      "vim",
                      new t.ShiftCommand(s, {
                        isUnshift: !o,
                        tabSize: r.tabSize,
                ...
                },
                {
                  key: "openDialog",
                  value: function (e, t, n) {
                    if (this.statusBar) return this.statusBar.setSec(e, t, n);
                  },
                },
                {
                  key: "openNotification",
                  value: function (e) {
                    this.statusBar && this.statusBar.showNotification(e);
                  },
                },
                {
                  key: "smartIndent",
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    "start" === e
                      ? (t.column = 1)
                      : "end" === e &&
                        (t.column = this.editor
                          .getModel()
                          .getLineMaxColumn(t.lineNumber)),
                      this.editor.setPosition(t);
                  },
                },
                {
                  key: "execCommand",
          ...
          (v.Pos = h),
            ...
            (v.e_stop = function (e) {
              return (
                ...
                v.e_preventDefault(e),
                !1
              );
            }),
            (v.e_preventDefault = function (e) {
              return (
                e.preventDefault
                  ? (e.preventDefault(),
                    e.browserEvent && e.browserEvent.preventDefault())
                  : (e.returnValue = !1),
                !1
              );
            }),
            (v.commands = {
              redo: function (e) {
                e.editor.getModel().redo();
              },
              undo: function (e) {
                e.editor.getModel().undo();
              },
              newlineAndIndent: function (e) {
                e.triggerEditorAction("editor.action.insertLineAfter");
              },
            }),
            (v.lookupKey = function e(t, n, r) {
              "string" == typeof n && (n = v.keyMap[n]);
          ...
          var y = function () {
            ...
            (this.handleKeyDown = function (n) {
              if (
                !(
                  n.browserEvent.defaultPrevented &
                  (n.keyCode !== e.KeyCode.Escape)
                ) &&
                t.attached
              ) {
                var r = m(n);
                if ((t.replaceMode && t.handleReplaceMode(r, n), r)) {
                  var o = t.state.keyMap;
                  if (v.keyMap[o] && v.keyMap[o].call) {
                    var i = v.keyMap[o].call(r, t);
                    if (i) {
              ...
              (this.handleCursorChange = function (n) {
                var r = n.position,
                  o = (n.source, t.editor),
                  i = o.getSelection();
                if (!t.ctxInsert.get() && "mouse" === n.source && i.isEmpty()) {
                  var a = o.getModel().getLineMaxColumn(r.lineNumber);
                  if (n.position.column === a)
                    return void o.setPosition(
                      new e.Position(n.position.lineNumber, a - 1)
                    );
                }
                t.dispatch("cursorActivity", t, n);
              }),
              (this.handleChange = function (e) {
                var n = {
                    text: e.changes.reduce(function (e, t) {
                ...
                r.changeHandlers ||
                  (r.changeHandlers =
                    t.listeners.change && t.listeners.change.slice()),
                  t.virtualSelectionMode() ||
                    (r.lastChange
                      ? (r.lastChange.next = r.lastChange = n)
                      : (r.lastChange = r.change = n),
                    t.dispatch("change", t, n));
              });
          };
          const k = v;
          function C(e) {
          ...
          k.Vim = (function () {
            function e(e, n) {
              (e.attached = !1),
                this == k.keyMap.vim && (e.options.$customCursor = null),
                (n && n.attach == t) ||
                  (function (e) {
                    e.setOption("disableInput", !1),
                      e.off("cursorActivity", Ye),
                      (e.state.vim = null),
                      Ve && clearTimeout(Ve),
                      e.leaveVimMode();
                  })(e);
            ...
            function t(e, n) {
              this == k.keyMap.vim &&
                ...
                (e.options.$customCursor = S)),
                (n && n.attach == t) ||
                  (function (e) {
                    e.setOption("disableInput", !0),
                      e.setOption("showCursorWhenSelecting", !1),
                      k.signal(e, "vim-mode-change", { mode: "normal" }),
                      e.on("cursorActivity", Ye),
                      D(e),
                      e.enterVimMode();
                  })(e);
            }
              ...
              if (t) {
                ...
                var n = (function (e) {
                  ...
                  for (var i = !1, a = 0; a < t.length; a++) {
                    var s = t[a];
                    s in r ? (t[a] = r[s]) : (i = !0), s in o && (t[a] = o[s]);
                  }
                  return (
                    !!i &&
                    (v(n) && (t[t.length - 1] = n.toLowerCase()),
                    "<" + t.join("-") + ">")
                  );
                })(e);
                if (!n) return !1;
                var i = j.findKey(t, n);
                return (
                  "function" == typeof i && k.signal(t, "vim-keypress", n), i
                );
              }
            }
            k.defineOption("vimMode", !1, function (e, t, n) {
            ...
            var r = {
              ...
              a = [
                k.isWordChar,
                function (e) {
                  return e && !k.isWordChar(e) && !/\s/.test(e);
                },
              ],
              s = [
                function (e) {
            ...
            function E(e, t, n, r, o) {
              ...
              if (
                (n || (n = "string"),
                (T[e] = { type: n, defaultValue: t, callback: o }),
                r)
              )
                for (var i = 0; i < r.length; i++) T[r[i]] = T[e];
              t && I(e, t);
            }
            function I(e, t, n, r) {
              var o = T[e],
            ...
            E("filetype", void 0, "string", ["ft"], function (e, t) {
              if (void 0 !== t) {
                if (void 0 === e)
                  return "null" == (n = t.getOption("mode")) ? "" : n;
                var n = "" == e ? "null" : e;
                t.setOption("mode", n);
              }
            });
            ...
            var j = {
              ...
              getRegisterController: function () {
                return O.registerController;
              },
              resetVimGlobalState_: V,
              ...
              defineEx: function (e, t, n) {
                ...
                (qe[e] = n),
                  (Je.commandMap_[t] = { name: e, shortName: t, type: "api" });
              },
                    ...
                    ? (function () {
                        ...
                        for (
                          var n = (o.inputState.keyBuffer =
                            ...
                            r = 1 == t.length,
                            a = $.matchCommand(n, M, o.inputState, "insert");
                          n.length > 1 && "full" != a.type;
  
                        ) {
                          n = o.inputState.keyBuffer = n.slice(1);
                          var s = $.matchCommand(n, M, o.inputState, "insert");
                          "none" != s.type && (a = s);
                        }
                        if ("none" == a.type) return W(e), !1;
                        if ("partial" == a.type)
                          return (
                            B && window.clearTimeout(B),
                            (B = window.setTimeout(function () {
                              o.insertMode && o.inputState.keyBuffer && W(e);
                            }, R("insertModeEscKeysTimeout"))),
                            !r
                          );
                        if ((B && window.clearTimeout(B), r)) {
                          for (
                            var l = e.listSelections(), c = 0;
                            c < l.length;
                            c++
                          ) {
                            var u = l[c].head;
                          ...
                          O.macroModeState.lastInsertModeChanges.changes.pop();
                        }
                        return W(e), a.command;
                      })()
                    : (function () {
                        if (
                          (function () {
                            var r = O.macroModeState;
                            if (r.isRecording) {
                              if ("q" == t)
                                return r.exitMacroRecordMode(), W(e), !0;
                              "mapping" != n &&
                                (function (e, t) {
                                  if (!e.isPlaying) {
                                    var n = e.latestRegister,
                                      r = O.registerController.getRegister(n);
                                    r && r.pushText(t);
                                  }
                                })(r, t);
                            }
                          ...
                          return !0;
                        var r = (o.inputState.keyBuffer =
                          o.inputState.keyBuffer + t);
                        if (/^[1-9]\d*$/.test(r)) return !0;
                        if (!(l = /^(\d*)(.*)$/.exec(r))) return W(e), !1;
                        var a = o.visualMode ? "visual" : "normal",
                          s = l[2] || l[1];
                        o.inputState.operatorShortcut &&
                          o.inputState.operatorShortcut.slice(-1) == s &&
                          (s = o.inputState.operatorShortcut);
                        var l,
                          c = $.matchCommand(s, M, o.inputState, a);
                        return "none" == c.type
                          ? (W(e), !1)
                          : "partial" == c.type ||
                              ...
                              (l = /^(\d*)(.*)$/.exec(r))[1] &&
                                "0" != l[1] &&
                                o.inputState.pushRepeatDigit(l[1]),
                              c.command);
                      })())
                  ? o.insertMode || 1 !== t.length
                    ? void 0
                    : function () {
                        return !0;
                      }
                            ...
                            ? (function (n) {
                                for (var r; n; )
                                  (r = /<\w+-.+?>|<\w+>|./.exec(n)),
                                    ...
                                    j.handleKey(e, t, "mapping");
                              })(r.toKeys)
                            : $.processCommand(e, o, r);
                        } catch (t) {
                          throw (
                            ((e.state.vim = void 0),
                            D(e),
                            j.suppressErrorLogging || console.log(t),
                            t)
                          );
                        }
                        return !0;
              ...
              defineRegister: function (e, t) {
                var n = O.registerController.registers;
                if (!e || 1 != e.length)
            ...
            function W(e, t) {
              (e.state.vim.inputState = new _()),
                k.signal(e, "vim-command-done", t);
            }
            function H(e, t, n) {
              this.clear(),
                (this.keyBuffer = [e || ""]),
            ...
            (_.prototype.pushRepeatDigit = function (e) {
              ...
              (H.prototype = {
                ...
                pushInsertModeChanges: function (e) {
                  this.insertModeChanges.push(N(e));
                },
              ...
              (F.prototype = {
                pushText: function (e, t, n, r, o) {
                  if ("_" !== e) {
                    ...
                    if (i)
                      v(e) ? i.pushText(n, r) : i.setText(n, r, o),
                        this.unnamedRegister.setText(i.toString(), r);
                    else {
                      switch (t) {
                        case "yank":
                          this.registers[0] = new H(n, r, o);
                          break;
                        case "delete":
                        case "change":
                          -1 == n.indexOf("\n")
                            ? (this.registers["-"] = new H(n, r))
                            : (this.shiftNumericRegisters_(),
                              (this.registers[1] = new H(n, r)));
                      }
                ...
                getRegister: function (e) {
                  return this.isValidRegister(e)
                    ? ((e = e.toLowerCase()),
                      this.registers[e] || (this.registers[e] = new H()),
                      this.registers[e])
            ...
            var $ = {
                ...
                processMotion: function (e, t, n) {
                  (t.inputState.motion = n.motion),
                    (t.inputState.motionArgs = X(n.motionArgs)),
                    this.evalInput(e, t);
                },
                ...
                processAction: function (e, t, n) {
                  var r = t.inputState,
                    ...
                    a = X(n.actionArgs) || {};
                  r.selectedCharacter &&
                    (a.selectedCharacter = r.selectedCharacter),
                ...
                processSearch: function (e, t, n) {
                  if (e.getSearchCursor) {
                    ...
                    switch (n.searchArgs.querySrc) {
                      case "prompt":
                        var l = O.macroModeState;
                        l.isPlaying
                          ? f((h = l.replaySearchQueries.shift()), !0, !1)
                          : Ke(e, {
                              onClose: function (t) {
                                e.scrollTo(s.left, s.top), f(t, !0, !0);
                                var n = O.macroModeState;
                                n.isRecording &&
                                  (function (e, t) {
                                    if (!e.isPlaying) {
                                      var n = e.latestRegister,
                              ...
                              onKeyUp: function (t, n, o) {
                                ...
                                "Up" == c || "Down" == c
                                  ? ((i = "Up" == c),
                                    ...
                                    o(
                                      (n =
                                        O.searchHistoryController.nextMatch(
                                          n,
                                          i
                                        ) || "")
                                    ),
                                  ...
                                  : "Left" != c &&
                                    ...
                                    "Alt" != c &&
                                    "Shift" != c &&
                                    O.searchHistoryController.reset();
                                try {
                                  l = De(e, n, !0, !0);
                                } catch (t) {}
                                l
                                  ? e.scrollIntoView(_e(e, !r, l), 30)
                                  : (We(e), e.scrollTo(s.left, s.top));
                              },
                              onKeyDown: function (t, n, r) {
                                ...
                                "Ctrl-[" == o ||
                                ("Backspace" == o && "" == n)
                                  ? (O.searchHistoryController.pushInput(n),
                                    O.searchHistoryController.reset(),
                                    De(e, a),
                                    We(e),
                      ...
                      case "wordUnderCursor":
                        var c = ve(e, !1, 0, !1, !0),
                          u = !0;
                        if ((c || ((c = ve(e, !1, 0, !1, !1)), (u = !1)), !c))
                          return;
                        var h = e
                          .getLine(c.start.line)
                          .substring(c.start.ch, c.end.ch);
                        (h =
                          u && o
                            ? "\\b" + h + "\\b"
                            : h.replace(/([.?*+$\[\]\/\\(){}|\-])/g, "\\$1")),
                          (O.jumpList.cachedCursor = e.getCursor()),
                          e.setCursor(c.start),
                          f(h, !0, !1);
                    }
                  }
                  function f(r, o, i) {
                    O.searchHistoryController.pushInput(r),
                      O.searchHistoryController.reset();
                    try {
                      De(e, r, o, i);
                    } catch (t) {
                      return Ne(e, "Invalid regex: " + r), void W(e);
                    }
                    $.processMotion(e, t, {
                      type: "motion",
                      motion: "findNext",
                ...
                processEx: function (e, t, n) {
                  function r(t) {
                    O.exCommandHistoryController.pushInput(t),
                      O.exCommandHistoryController.reset(),
                      Je.processCommand(e, t);
                  }
                  function o(t, n, r) {
                    var o,
                    ...
                    ("Esc" == a ||
                      ...
                      "Ctrl-[" == a ||
                      ("Backspace" == a && "" == n)) &&
                      (O.exCommandHistoryController.pushInput(n),
                      O.exCommandHistoryController.reset(),
                      k.e_stop(t),
                      W(e),
                      r(),
                      ...
                      "Up" == a || "Down" == a
                        ? (k.e_stop(t),
                          ...
                          r(
                            (n =
                              O.exCommandHistoryController.nextMatch(n, o) || "")
                          ),
                          i &&
                            t.target &&
                  ...
                  "keyToEx" == n.type
                    ? Je.processCommand(e, n.exArgs.input)
                    : t.visualMode
                    ? Ke(e, {
                        onClose: r,
                        prefix: ":",
                    ...
                    : Ke(e, { onClose: r, prefix: ":", onKeyDown: o });
                },
                evalInput: function (e, t) {
                  var n,
                    ...
                    u = i.registerName,
                    h = t.sel,
                    f = te(t.visualMode ? G(e, h.head) : e.getCursor("head")),
                    d = te(t.visualMode ? G(e, h.anchor) : e.getCursor("anchor")),
                    p = te(f),
                    g = te(d);
                  if (
                    (l && this.recordLastEdit(t, i),
                    (o =
                    ...
                    var m = q[a](e, f, s, t, i);
                    if (((t.lastMotion = q[a]), !m)) return;
                    if (s.toJumplist) {
                      var v = O.jumpList,
                        k = v.cachedCursor;
                      k ? (ye(e, k, m), delete v.cachedCursor) : ye(e, f, m);
                    }
                    m instanceof Array ? ((r = m[0]), (n = m[1])) : (n = m),
                      n || (n = te(f)),
                      t.visualMode
                        ? ((t.visualBlock && n.ch === 1 / 0) || (n = G(e, n)),
                          r && (r = G(e, r)),
                          (r = r || g),
                          (h.anchor = r),
                          (h.head = n),
                          ...
                          be(e, t, "<", re(r, n) ? r : n),
                          be(e, t, ">", re(r, n) ? n : r))
                        : l || ((n = G(e, n)), e.setCursor(n.line, n.ch));
                  }
                  if (l) {
                    if (c.lastSel) {
                      r = g;
                      var C = c.lastSel,
                        S = Math.abs(C.head.line - C.anchor.line),
                        M = Math.abs(C.head.ch - C.anchor.ch);
                      (n = C.visualLine
                        ? new w(g.line + S, g.ch)
                        : C.visualBlock
                        ? new w(g.line + S, g.ch + M)
                    ...
                    if (t.visualMode) {
                      if (
                        ((x = oe(h.head, h.anchor)),
                        (b = ie(h.head, h.anchor)),
                        (A = t.visualLine || c.linewise),
                        (T = pe(
                          e,
                          { anchor: x, head: b },
                          (L = t.visualBlock ? "block" : A ? "line" : "char")
                        )),
                        A)
                      ) {
                        var E = T.ranges;
                        if ("block" == L)
                          for (var I = 0; I < E.length; I++)
                            E[I].head.ch = se(e, E[I].head.line);
                        else
                          "line" == L &&
                            (E[0].head = new w(E[0].head.line + 1, 0));
                      }
                    } else {
                      if (((x = te(r || g)), re((b = te(n || p)), x))) {
                        var R = x;
                        (x = b), (b = R);
                      }
                      (A = s.linewise || c.linewise)
                        ? (function (e, t, n) {
                          ...
                          (function (e, t, n) {
                            ...
                            if (/\n\s*$/.test(r)) {
                              ...
                              for (
                                ...
                                n.line--, (n.ch = 0);
                              i ? (n.line--, (n.ch = se(e, n.line))) : (n.ch = 0);
                            }
                          })(e, x, b),
                        (T = pe(
                          e,
                    ...
                    e.setSelections(T.ranges, T.primary),
                      ...
                      (c.registerName = u),
                      (c.linewise = A);
                    var B = z[l](e, c, T.ranges, g, n);
                    t.visualMode && ge(e, null != B), B && e.setCursor(B);
                  }
                },
              ...
              q = {
                moveToTopLine: function (e, t, n) {
                  var r = He(e).top + n.repeat - 1;
                  return new w(r, me(e.getLine(r)));
                },
                moveToMiddleLine: function (e) {
                  var t = He(e),
                    n = Math.floor(0.5 * (t.top + t.bottom));
                  return new w(n, me(e.getLine(n)));
                },
                moveToBottomLine: function (e, t, n) {
                  var r = He(e).bottom - n.repeat + 1;
                  return new w(r, me(e.getLine(r)));
                },
                expandToLine: function (e, t, n) {
                  return new w(t.line + n.repeat - 1, 1 / 0);
                },
                ...
                findAndSelectNextInclusive: function (e, t, n, r, o) {
                  ...
                  if (a) {
                        ...
                        return (
                          ...
                          e.operation(function () {
                            var i = e.getCursor(),
                              ...
                              s = a.find(!t);
                            !o.visualMode && s && ne(a.from(), i) && a.find(!t);
                            for (var l = 0; l < r; l++)
                              if (
                                !(s = a.find(t)) &&
                                !(a = e.getSearchCursor(
                    ...
                    if (l) {
                      ...
                      var c = l[0],
                        u = new w(l[1].line, l[1].ch - 1);
                      if (r.visualMode) {
                        (r.visualLine || r.visualBlock) &&
                          ((r.visualLine = !1),
                          (r.visualBlock = !1),
                          k.signal(e, "vim-mode-change", {
                            mode: "visual",
                            subMode: "",
                          }));
                        var h = r.sel.anchor;
                ...
                goToMark: function (e, t, n, r) {
                  var o = Fe(e, r, n.selectedCharacter);
                  return o
                    ? n.linewise
                      ? { line: o.line, ch: me(e.getLine(o.line)) }
                      : o
                    : null;
                },
                moveToOtherHighlightedEnd: function (e, t, n, r) {
                  if (r.visualBlock && n.sameLine) {
                    var o = r.sel;
                    return [
                      G(e, new w(o.anchor.line, o.head.ch)),
                      G(e, new w(o.head.line, o.anchor.ch)),
                    ];
                  }
                ...
                jumpToMark: function (e, t, n, r) {
                  for (var o = t, i = 0; i < n.repeat; i++) {
                    ...
                    for (var s in r.marks)
                      if (m(s)) {
                        var l = r.marks[s].find();
                        if (
                          !(
                            (n.forward ? re(l, a) : re(a, l)) ||
                            (n.linewise && l.line == a.line)
                          )
                        ) {
                          var c = ne(a, o),
                            u = n.forward ? ae(a, l, o) : ae(o, l, a);
                          (c || u) && (o = l);
                        }
                      }
                  }
                  return (
                    n.linewise && (o = new w(o.line, me(e.getLine(o.line)))), o
                  );
                },
                ...
                moveByLines: function (e, t, n, r) {
                  ...
                  var a = n.repeat + (n.repeatOffset || 0),
                    ...
                    l = e.firstLine(),
                    c = e.lastLine(),
                    u = e.findPosV(o, n.forward ? a : -a, "line", r.lastHSPos);
                  return (
                    (n.forward ? u.line > s : u.line < s) &&
                      ((s = u.line), (i = u.ch)),
                    s < l && o.line == l
                      ...
                      ? Me(e, t, n, r, !0)
                      : (n.toFirstChar &&
                          ((i = me(e.getLine(s))), (r.lastHPos = i)),
                        (r.lastHSPos = e.charCoords(new w(s, i), "div").left),
                        new w(s, i))
                  );
                },
                moveByDisplayLines: function (e, t, n, r) {
                  ...
                  if (
                    ...
                    if (n.forward)
                      ...
                      var l = e.charCoords(new w(e.firstLine(), 0), "div");
                      (l.left = r.lastHSPos), (s = e.coordsChar(l, "div"));
                    }
                  ...
                  return (function (e, t, n, r) {
                    function o(e, t) {
                      if (t.pos + t.dir < 0 || t.pos + t.dir >= t.line.length) {
                        if (((t.ln += t.dir), !g(e, t.ln)))
                          return (
                            (t.line = null), (t.ln = null), void (t.pos = null)
                          );
                    ...
                    function i(e, t, n, r) {
                      ...
                      for (o(e, a); null !== a.line; ) {
                        if (((s.ln = a.ln), (s.pos = a.pos), "" === a.line && !l))
                          return { ln: a.ln, pos: a.pos };
                        if (i && "" !== a.line && !y(a.line[a.pos]))
                          return { ln: a.ln, pos: a.pos };
                        !A(a.line[a.pos]) ||
                          i ||
                    ...
                    for (var s = { ln: t.line, pos: t.ch }; n > 0; )
                      (s = r < 0 ? a(e, s.ln, s.pos, r) : i(e, s.ln, s.pos, r)),
                        n--;
                    return new w(s.ln, s.pos);
                  })(e, t, n.repeat, r);
                },
                moveByScroll: function (e, t, n, r) {
                  ...
                  if (((n.repeat = a), !(o = q.moveByDisplayLines(e, t, n, r))))
                    return null;
                ...
                moveByWords: function (e, t, n) {
                  return (function (e, t, n, r, o, i) {
                    var a = te(t),
                      s = [];
                    ((r && !o) || (!r && o)) && n++;
                    for (var l = !(r && o), c = 0; c < n; c++) {
                      var u = Se(e, t, r, i, l);
                      if (!u) {
                        var h = se(e, e.lastLine());
                        s.push(
                          r
                      ...
                      s.push(u), (t = new w(u.line, r ? u.to - 1 : u.from));
                    }
                    var f = s.length != n,
                      d = s[0],
                      p = s.pop();
                    return r && !o
                      ? (f ||
                          (d.from == a.ch && d.line == a.line) ||
                          (p = s.pop()),
                        new w(p.line, p.from))
                      : r && o
                      ? new w(p.line, p.to - 1)
                      : !r && o
                      ? (f || (d.to == a.ch && d.line == a.line) || (p = s.pop()),
                        new w(p.line, p.to))
                      : new w(p.line, p.from);
                  })(e, t, n.repeat, !!n.forward, !!n.wordEnd, !!n.bigWord);
                },
                moveTillCharacter: function (e, t, n) {
                  var r = xe(e, n.repeat, n.forward, n.selectedCharacter),
                    o = n.forward ? -1 : 1;
                  return ke(o, n), r ? ((r.ch += o), r) : null;
                },
                moveToCharacter: function (e, t, n) {
                  var r = n.repeat;
                  return ke(0, n), xe(e, r, n.forward, n.selectedCharacter) || t;
                },
                moveToSymbol: function (e, t, n) {
                  return (
                    (function (e, t, n, r) {
                      var o = te(e.getCursor()),
                        i = n ? 1 : -1,
                        a = n ? e.lineCount() : -1,
                        s = o.ch,
                        l = o.line,
                      ...
                      for (f && f(u); l !== a && t; ) {
                        if (
                          ...
                          if (
                            ((l += i), (u.lineText = e.getLine(l) || ""), i > 0)
                          )
                            u.index = 0;
                          else {
                        ...
                        d(u) && ((o.line = l), (o.ch = u.index), t--);
                      }
                      return u.nextCh || u.curMoveThrough ? new w(l, u.index) : o;
                ...
                moveToFirstNonWhiteSpaceCharacter: function (e, t) {
                  var n = t;
                  return new w(n.line, me(e.getLine(n.line)));
                },
                moveToMatchedSymbol: function (e, t) {
                  var n = t,
                    r = n.line,
                    o = n.ch;
                  if (o < e.getLine(r).length) {
                    var i = "<" === o || ">" === o ? /[(){}[\]<>]/ : /[(){}[\]]/;
                    return e.findMatchingBracket(new w(r, o), { bracketRegex: i })
                      .to;
                  }
                  return n;
                },
                ...
                textObjectManipulation: function (e, t, n, r) {
                  ...
                  if (
                    ...
                    i = (function (e, t, n, r) {
                      ...
                      return r ? (i.ch += 1) : (o.ch += 1), { start: o, end: i };
                    })(e, t, o, a);
                  else if ({ "'": !0, '"': !0, "`": !0 }[o])
                    i = (function (e, t, n, r) {
                      var o,
                      ...
                      return o && i
                        ? (r && (--o, ++i),
                          { start: new w(l.line, o), end: new w(l.line, i) })
                        : { start: l, end: l };
                    })(e, t, o, a);
                  else if ("W" === o) i = ve(e, a, 0, !0);
                  else if ("w" === o) i = ve(e, a, 0, !1);
                  else if ("p" === o)
                    if (
                      ((i = Le(e, t, n.repeat, 0, a)),
                      (n.linewise = !0),
                      r.visualMode)
                    )
                    ...
                    i = (function (e, t, n) {
                      var r = t;
                      if (!k.findMatchingTag || !k.findEnclosingTag)
                        return { start: r, end: r };
                      var o = k.findMatchingTag(e, t) || k.findEnclosingTag(e, t);
                    ...
                    ? (function (e, t, n) {
                        ...
                        return (
                          ...
                          re(i, a)
                            ? ((i = oe(t, i)), (a = ie(a, n)))
                            : ((a = oe(t, a)),
                              -1 == (i = Y((i = ie(i, n)), 0, -1)).ch &&
                                i.line != e.firstLine() &&
                                (i = new w(i.line - 1, se(e, i.line - 1)))),
                          [a, i]
                        );
                      })(e, i.start, i.end)
                    : [i.start, i.end];
            ...
            var z = {
                change: function (e, t, n) {
                  ...
                  if (i.visualMode)
                    if (t.fullLine)
                      ...
                      o = e.getSelection();
                      var l = J("", n.length);
                      e.replaceSelections(l), (r = oe(n[0].head, n[0].anchor));
                    }
                  else {
                    o = e.getRange(a, s);
                    var c = i.lastEditInputState || {};
                    if ("moveByWords" == c.motion && !y(o)) {
                      var u = /\s+$/.exec(o);
                      u &&
                        c.motionArgs &&
                    ...
                    var h = new w(a.line - 1, Number.MAX_VALUE),
                      f = e.firstLine() == e.lastLine();
                    s.line > e.lastLine() && t.linewise && !f
                      ? e.replaceRange("", h, s)
                      : e.replaceRange("", a, s),
                      t.linewise &&
                        (f || (e.setCursor(h), k.commands.newlineAndIndent(e)),
                        (a.ch = Number.MAX_VALUE)),
                      (r = a);
                  }
                  O.registerController.pushText(
                    t.registerName,
                    "change",
                    o,
                    t.linewise,
                    ...
                    Q.enterInsertMode(e, { head: r }, e.state.vim);
                },
                delete: function (e, t, n) {
                  ...
                  if (i.visualBlock) {
                    o = e.getSelection();
                    var a = J("", n.length);
                    e.replaceSelections(a), (r = oe(n[0].head, n[0].anchor));
                  } else {
                    var s = n[0].anchor,
                      l = n[0].head;
                    t.linewise &&
                      ...
                      (s.line == e.firstLine()
                        ? (s.ch = 0)
                        : (s = new w(s.line - 1, se(e, s.line - 1)))),
                      (o = e.getRange(s, l)),
                      e.replaceRange("", s, l),
                      (r = s),
                      t.linewise &&
                        (r = q.moveToFirstNonWhiteSpaceCharacter(e, s));
                  }
                  return (
                    O.registerController.pushText(
                      t.registerName,
                ...
                indent: function (e, t, n) {
                  ...
                  return (
                    e.pushUndoStop(),
                    q.moveToFirstNonWhiteSpaceCharacter(e, n[0].anchor)
                  );
                },
                  ...
                  for (
                    ...
                    if (!0 === s) u = c.toLowerCase();
                      ...
                      for (var h = 0; h < c.length; h++) {
                        var f = c.charAt(h);
                        u += v(f) ? f.toLowerCase() : f.toUpperCase();
                      }
                    a.push(u);
                  }
                  return (
                    ...
                    t.shouldMoveCursor
                      ...
                      ? q.moveToFirstNonWhiteSpaceCharacter(e, r)
                      : t.linewise
                      ? r
                      : oe(n[0].anchor, n[0].head)
                  );
                },
                yank: function (e, t, n, r) {
                  var o = e.state.vim,
                    i = e.getSelection(),
                    a = o.visualMode
                      ? oe(o.sel.anchor, o.sel.head, n[0].head, n[0].anchor)
                      : r;
                  return (
                    O.registerController.pushText(
                      t.registerName,
              ...
              Q = {
                    ...
                    if (t.forward)
                      ...
                      u < c.bottom
                        ? ((l.line -= (c.bottom - u) / o),
                          ...
                          e.scrollTo(
                            null,
                            c.bottom - e.getScrollInfo().clientHeight
                          ))
                        : e.scrollTo(null, s);
                    }
                  }
                ...
                enterMacroRecordMode: function (e, t) {
                  ...
                  O.registerController.isValidRegister(r) &&
                ...
                toggleOverwrite: function (e) {
                  e.state.overwrite
                    ? (e.toggleOverwrite(!1),
                      ...
                      k.signal(e, "vim-mode-change", { mode: "insert" }))
                    : (e.toggleOverwrite(!0),
                      e.setOption("keyMap", "vim-replace"),
                      k.signal(e, "vim-mode-change", { mode: "replace" }));
                },
                enterInsertMode: function (e, t, n) {
                  if (!e.getOption("readOnly")) {
                    (n.insertMode = !0),
                      (n.insertModeRepeat = (t && t.repeat) || 1);
                    var r = t ? t.insertAt : null,
                      o = n.sel,
                      i = t.head || e.getCursor("head"),
                      a = e.listSelections().length;
                    if ("eol" == r) i = new w(i.line, se(e, i.line));
                    else if ("bol" == r) i = new w(i.line, 0);
                    else if ("charAfter" == r) i = Y(i, 0, 1);
                    else if ("firstNonBlank" == r)
                      i = q.moveToFirstNonWhiteSpaceCharacter(e, i);
                    ...
                    e.setOption("disableInput", !1),
                      t && t.replace
                        ...
                        : (e.toggleOverwrite(!1),
                          e.setOption("keyMap", "vim-insert"),
                          k.signal(e, "vim-mode-change", { mode: "insert" })),
                      O.macroModeState.isPlaying ||
                        (e.on("change", Xe),
                        k.on(e.getInputField(), "keydown", et)),
                      n.visualMode && ge(e),
                      he(e, i, a);
                  }
                },
                toggleVisualMode: function (e, t, n) {
                  ...
                  n.visualMode
                    ...
                    : ((n.visualMode = !0),
                      (n.visualLine = !!t.linewise),
                      (n.visualBlock = !!t.blockwise),
                      (r = G(e, new w(i.line, i.ch + o - 1))),
                      (n.sel = { anchor: i, head: r }),
                      k.signal(e, "vim-mode-change", {
                        mode: "visual",
                        subMode: n.visualLine
                          ? "linewise"
                ...
                joinLines: function (e, t, n) {
                  ...
                  if (n.visualMode) {
                    ...
                    (r = e.getCursor()), (o = G(e, new w(r.line + a - 1, 1 / 0)));
                  }
                  for (var s = 0, l = r.line; l < o.line; l++) {
                    (s = se(e, r.line)),
                      (i = new w(r.line + 1, se(e, r.line + 1)));
                    var c = e.getRange(r, i);
                    (c = t.keepSpaces
                      ? c.replace(/\n\r?/g, "")
                      : c.replace(/\n\s*/g, " ")),
                      e.replaceRange(c, r, i);
                  }
                  var u = new w(r.line, s);
                  n.visualMode && ge(e, !1), e.setCursor(u);
                },
                newLineAndEnterInsertMode: function (e, t, n) {
                  if (!e.getOption("readOnly")) {
                    n.insertMode = !0;
                    var r = te(e.getCursor());
                    r.line !== e.firstLine() || t.after
                      ? ((r.line = t.after ? r.line : r.line - 1),
                        (r.ch = se(e, r.line)),
                        e.setCursor(r),
                        (
                          k.commands.newlineAndIndentContinueComment ||
                          k.commands.newlineAndIndent
                        )(e))
                      : (e.replaceRange("\n", new w(e.firstLine(), 0)),
                ...
                paste: function (e, t, n) {
                  var r = te(e.getCursor()),
                    o = O.registerController.getRegister(t.registerName);
                  if ((f = o.toString())) {
                    if (t.matchIndent) {
                      var i = e.getOption("tabSize"),
                        a = function (e) {
                    ...
                    if (m) {
                      ...
                      for (var v = 0; v < f.length; v++)
                        f[v] = "" == f[v] ? " " : f[v];
                      (r.ch += t.after ? 1 : 0),
                        (r.ch = Math.min(se(e, r.line), r.ch));
                    } else
                      g
                        ? n.visualMode
                          ? (f = n.visualLine
                    ...
                    if (n.visualMode) {
                      ...
                      var k = (function (e, t) {
                          ...
                          return t.visualMode
                            ? (function () {
                                var t = e.listSelections(),
                                  ...
                                  r = t[t.length - 1];
                                return [
                                  re(n.anchor, n.head) ? n.anchor : n.head,
                                  re(r.anchor, r.head) ? r.head : r.anchor,
                                ];
                              })()
                            : (function () {
                                var t = e.getCursor(),
                                ...
                                if (o) {
                                  var i = o.width,
                                    a = o.height;
                                  r = new w(t.line + a, t.ch + i);
                                  for (var s = [], l = t.line; l < r.line; l++) {
                                    var c = {
                                      anchor: new w(l, t.ch),
                                      head: new w(l, r.ch),
                                    };
                        ...
                        M = e.getSelection(),
                        x = e.listSelections(),
                        b = new Array(x.length).join("1").split("1");
                      n.lastSelection && (y = n.lastSelection.headMark.find()),
                        O.registerController.unnamedRegister.setText(M),
                        m
                          ? (e.replaceSelections(b),
                            (S = new w(C.line + f.length - 1, C.ch)),
                            e.setCursor(C),
                            ue(e, S),
                          ...
                          ? (e.replaceSelections(b),
                            e.setCursor(C),
                            e.replaceRange(f, C, C),
                            (d = C))
                          : (e.replaceRange(f, C, S),
                            (d = e.posFromIndex(
                              e.indexFromPos(C) + f.length - 1
                            ))),
                        y && (n.lastSelection.headMark = e.setBookmark(y)),
                        g && (d.ch = 0);
                    } else if (m) {
                      for (e.setCursor(r), v = 0; v < f.length; v++) {
                        var A = r.line + v;
                        A > e.lastLine() && e.replaceRange("\n", new w(A, 0)),
                          se(e, A) < r.ch && ce(e, A, r.ch);
                      }
                      e.setCursor(r),
                        ue(e, new w(r.line + f.length - 1, r.ch)),
                        e.replaceSelections(f),
                        (d = r);
                    } else
                      e.replaceRange(f, r),
                        g && t.after
                          ? (d = new w(r.line + 1, me(e.getLine(r.line + 1))))
                          : g && !t.after
                          ? (d = new w(r.line, me(e.getLine(r.line))))
                          : !g && t.after
                          ? ((p = e.indexFromPos(r)),
                            (d = e.posFromIndex(p + f.length - 1)))
                          : ((p = e.indexFromPos(r)),
                            (d = e.posFromIndex(p + f.length)));
                    n.visualMode && ge(e, !1), e.setCursor(d);
                  }
                },
                undo: function (e, t) {
                  e.operation(function () {
                    ee(e, k.commands.undo, t.repeat)(),
                      e.setCursor(e.getCursor("anchor"));
                  });
                },
                redo: function (e, t) {
                  ee(e, k.commands.redo, t.repeat)();
                },
                setRegister: function (e, t, n) {
                  n.inputState.registerName = t.selectedCharacter;
                },
                setMark: function (e, t, n) {
                  be(e, n, t.selectedCharacter, e.getCursor());
                },
                replace: function (e, t, n) {
                  ...
                  if (n.visualMode)
                    ...
                    (r = a.ch + t.repeat) > l.length && (r = l.length),
                      (o = new w(a.line, r));
                  }
                  if ("\n" == i)
                ...
                incrementNumberToken: function (e, t) {
                  ...
                  if ((t.backtrack || !(o <= a.ch)) && n) {
                    var c = n[2] || n[4],
                      u = n[3] || n[5],
                      h = t.increase ? 1 : -1,
                      f = { "0b": 2, 0: 8, "": 10, "0x": 16 }[c.toLowerCase()];
                    i = (parseInt(n[1] + u, f) + h * t.repeat).toString(f);
                    var d = c
                      ? new Array(u.length - i.length + 1 + n[1].length).join("0")
                      : "";
                    i =
                      "-" === i.charAt(0) ? "-" + c + d + i.substr(1) : c + d + i;
                    var p = new w(a.line, r),
                      g = new w(a.line, o);
                    e.replaceRange(i, p, g),
                      e.setCursor(new w(a.line, r + i.length - 1));
                  }
                },
            ...
            function ce(e, t, n) {
              ...
              e.setCursor(new w(t, r)), e.replaceRange(o, e.getCursor());
            }
            function ue(e, t) {
              var n = [],
                r = e.listSelections(),
                ...
                a = (function (e, t, n) {
                  for (var r = 0; r < e.length; r++) {
                    var o = ne(e[r].anchor, t),
                      i = ne(e[r].head, t);
                    if (o || i) return r;
                  }
                  return -1;
                })(r, e.getCursor("head")),
                s = ne(r[a].head, r[a].anchor),
                l = r.length - 1,
                c = l - a > a ? l : 0,
                u = r[c].anchor,
                h = Math.min(u.line, o.line),
                f = Math.max(u.line, o.line),
                d = u.ch,
                p = o.ch,
                g = r[c].head.ch - d,
                m = p - d;
              g > 0 && m <= 0
                ...
                : g < 0 && -1 == m && (d--, p++);
              for (var v = h; v <= f; v++) {
                var y = { anchor: new w(v, d), head: new w(v, p) };
                n.push(y);
              }
              return e.setSelections(n), (t.ch = p), (u.ch = d), u;
            }
            function he(e, t, n) {
              for (var r = [], o = 0; o < n; o++) {
                var i = Y(t, o, 0);
            ...
            function fe(e, t) {
              ...
              t.lastPastedText &&
                ((r = e.posFromIndex(
                  e.indexFromPos(n) + t.lastPastedText.length
                )),
            ...
            function pe(e, t, n, r) {
              var o = te(t.head),
                i = te(t.anchor);
              if ("char" == n) {
                var a = r || re(t.head, t.anchor) ? 0 : 1,
                  s = re(t.head, t.anchor) ? 1 : 0;
                return (
                  (o = Y(t.head, 0, a)),
                  {
                    ranges: [{ anchor: (i = Y(t.anchor, 0, s)), head: o }],
                    primary: 0,
                  }
                );
              }
              if ("line" == n) {
                if (re(t.head, t.anchor)) (o.ch = 0), (i.ch = se(e, i.line));
                else {
                  i.ch = 0;
                  var l = e.lastLine();
                  o.line > l && (o.line = l), (o.ch = se(e, o.line));
                }
              ...
              if ("block" == n) {
                ...
                u < f ? (f += 1) : (u += 1);
                for (
                  var d = h - c + 1, p = o.line == c ? 0 : d - 1, g = [], m = 0;
                  m < d;
                  m++
                )
                  g.push({ anchor: new w(c + m, u), head: new w(c + m, f) });
                return { ranges: g, primary: p };
              }
            }
            function ge(e, t) {
              var n = e.state.vim;
              !1 !== t && e.setCursor(G(e, n.sel.head)),
                fe(e, n),
                (n.visualMode = !1),
                (n.visualLine = !1),
                (n.visualBlock = !1),
            ...
            function ve(e, t, n, r, o) {
              ...
              if ((f++, t)) {
                for (var d = h; /\s/.test(l.charAt(h)) && h < l.length; ) h++;
                if (d == h) {
                  for (var p = f; /\s/.test(l.charAt(f - 1)) && f > 0; ) f--;
                  f || (f = p);
                }
              }
              return { start: new w(i.line, f), end: new w(i.line, h) };
            }
            function ye(e, t, n) {
              ne(t, n) || O.jumpList.add(e, t, n);
            }
            function ke(e, t) {
              (O.lastCharacterSearch.increment = e),
                (O.lastCharacterSearch.forward = t.forward),
                (O.lastCharacterSearch.selectedCharacter = t.selectedCharacter);
            }
            var Ce = {
                "(": "bracket",
                ")": "bracket",
            ...
            function Se(e, t, n, r, o) {
              var i = t.line,
                ...
                h = r ? s : a;
              if (o && "" == c) {
                if (((i += u), (c = e.getLine(i)), !g(e, i))) return null;
                l = n ? 0 : c.length;
              }
              for (;;) {
                if (o && "" == c) return { from: 0, to: 0, line: i };
                for (var f = u > 0 ? c.length : -1, d = f, p = f; l != f; ) {
                  for (var m = !1, v = 0; v < h.length && !m; ++v)
                    if (h[v](c.charAt(l))) {
                      for (d = l; l != f && h[v](c.charAt(l)); ) l += u;
                      if (
                        ((m = d != (p = l)),
                        d == t.ch && i == t.line && p == d + u)
                      )
                        continue;
                      return {
                        from: Math.min(d, p + 1),
                ...
                if (!g(e, (i += u))) return null;
                (c = e.getLine(i)), (l = u > 0 ? 0 : c.length);
              }
            }
            function Me(e, t, n, r, o) {
              var i = new w(t.line + n.repeat - 1, 1 / 0),
                a = e.clipPos(i);
              return (
                a.ch--,
                o ||
                  ((r.lastHPos = 1 / 0),
                  (r.lastHSPos = e.charCoords(a, "div").left)),
                i
              );
            }
            function xe(e, t, n, r) {
              for (var o, i = e.getCursor(), a = i.ch, s = 0; s < t; s++) {
                if (-1 == (o = Ae(a, e.getLine(i.line), r, n, !0))) return null;
                a = o;
              }
            ...
            function Le(e, t, n, r, o) {
              ...
              if (r) {
                for (; s <= c && c <= l && n > 0; ) h(c, r) && n--, (c += r);
                return new w(c, 0);
              }
              var f = e.state.vim;
              if (f.visualLine && h(a, 1, !0)) {
                var d = f.sel.anchor;
                h(d.line, -1, !0) && ((o && d.line == a) || (a += 1));
              }
              var p = u(a);
              for (c = a; c <= l && n; c++)
                h(c, 1, !0) && ((o && u(c) == p) || n--);
              for (
                i = new w(c, 0), c > l && !p ? (p = !0) : (o = !1), c = a;
                c > s && ((o && u(c) != p && c != a) || !h(c, -1, !0));
                c--
              );
              return { start: new w(c, 0), end: i };
            }
            function Te() {}
            function Ee(e) {
              var t = e.state.vim;
            ...
            function Ie(e, t) {
              ...
              if (0 === n[0]) {
                for (var o = 0; o < n.length; o++)
                  "number" == typeof n[o] &&
                    r.push(e.substring(n[o] + 1, n[o + 1]));
                return r;
              }
            }
            function Re(e, t) {
            ...
            function Pe(e) {
              ...
              for (var t, n = 1; n < arguments.length; n++)
                if ((t = arguments[n]))
                  if (
                    ("object" !== C(t) && (t = document.createTextNode(t)),
                    t.nodeType)
                  )
                    e.appendChild(t);
                  else
            ...
            function Ne(e, t) {
              var n = Pe("pre", { $color: "red", class: "cm-vim-message" }, t);
              e.openNotification
            ...
            function De(e, t, n, r) {
              if (t) {
                var o = Ee(e),
                  i = (function (e, t, n) {
                    if (
                      (O.registerController.getRegister("/").setText(e),
                      e instanceof RegExp)
                    )
                      return e;
                    var r,
                  ...
                  if (e.state.vim) {
                    ...
                    (r && t == r.query) ||
                      ...
                      e.showMatchesOnScrollbar &&
                        (n.getScrollbarAnnotate() &&
                          n.getScrollbarAnnotate().clear(),
              ...
              return (
                ...
                e.operation(function () {
                  for (
                    ...
                    var s = i.find(t);
                    if (0 == a && s && ne(i.from(), o)) {
                      var l = t ? i.from() : i.to();
                      (s = i.find(t)) &&
                        !s[0] &&
                        ne(i.from(), l) &&
                        e.getLine(l.line).length == l.ch &&
                        (s = i.find(t));
                    }
                    if (
                      !s &&
            ...
            function He(e) {
              var t = e.getScrollInfo(),
                ...
                o = e.coordsChar({ left: 0, top: r }, "local");
              return { top: n.line, bottom: o.line };
            }
            function Fe(e, t, n) {
              if ("'" == n || "`" == n)
                return O.jumpList.find(e, -1) || new w(0, 0);
              if ("." == n) return Ue(e);
              var r = t.marks[n];
              return r && r.find();
            }
            function Ue(e) {
              for (var t = e.doc.history.done, n = t.length; n--; )
                if (t[n].changes) return te(t[n].changes[0].to);
            }
            var $e = function () {
            ...
            $e.prototype = {
              ...
              _processCommand: function (e, t, n) {
                var r = e.state.vim,
                  o = O.registerController.getRegister(":"),
                  i = o.toString();
                r.visualMode && ge(e);
                var a = new k.StringStream(t);
                o.setText(t);
                var s,
                  l,
                  c = n || {};
                  ...
                  if ((s = this.matchCommand_(c.commandName))) {
                    if (
                      ...
                      for (var u = 0; u < s.toKeys.length; u++)
                        j.handleKey(e, s.toKeys[u], "mapping");
                      return;
                    }
                    if ("exToEx" == s.type)
                ...
                else Ne(e, 'Not an editor command ":' + t + '"');
              },
              ...
              parseLineSpec_: function (e, t) {
                ...
                switch (t.next()) {
                  ...
                  case "+":
                    return (
                      t.backUp(1),
                      this.parseLineSpecOffset_(t, e.getCursor().line)
                    );
                  default:
              ...
              unmap: function (e, t) {
                if (":" != e && ":" == e.charAt(0)) {
                  ...
                  for (var r = e, o = 0; o < M.length; o++)
                    if (r == M[o].keys && M[o].context === t)
                      return M.splice(o, 1), !0;
              },
            };
            var qe = {
                colorscheme: function (e, t) {
                  !t.args || t.args.length < 1
                    ? Ne(e, e.getOption("theme"))
                    : e.setOption("theme", t.args[0]);
                },
                map: function (e, t, n) {
                  var r = t.args;
                  !r || r.length < 2
                    ? e && Ne(e, "Invalid mapping: " + t.input)
                    : Je.map(r[0], r[1], n);
                },
                imap: function (e, t) {
                  this.map(e, t, "insert");
                ...
                unmap: function (e, t, n) {
                  var r = t.args;
                  (!r || r.length < 1 || !Je.unmap(r[0], n)) &&
                    e &&
                    Ne(e, "No such mapping: " + t.input);
                },
                move: function (e, t) {
                ...
                set: function (e, t) {
                  ...
                  if (!n || n.length < 1)
                    ...
                    if ((l && null == a && (a = !0), (!l && void 0 === a) || s)) {
                      ...
                      var u = I(i, a, e, r);
                      u instanceof Error && Ne(e, u.message);
                    }
                  }
                },
                ...
                registers: function (e, t) {
                  var n = t.args,
                    r = O.registerController.registers,
                    o = "----------Registers----------\n\n";
                  if (n) {
                    n = n.join("");
                    for (var i = 0; i < n.length; i++)
                      (a = n.charAt(i)),
                        O.registerController.isValidRegister(a) &&
                          (o +=
                            '"' +
                            a +
                            "    " +
                ...
                sort: function (e, t) {
                  var n,
                    ...
                    s = (function () {
                      if (t.argString) {
                        var e = new k.StringStream(t.argString);
                  ...
                  if (s) Ne(e, s + ": " + t.argString);
                  else {
                    var l = t.line || e.firstLine(),
                      c = t.lineEnd || t.line || e.lastLine();
                    if (l != c) {
                      var u = new w(l, 0),
                        h = new w(c, se(e, c)),
                        f = e.getRange(u, h).split("\n"),
                        d =
                          a ||
                          ("decimal" == i
                            ? /(-?)([\d]+)/
                      ...
                      if (
                        ...
                        for (v = 0; v < g.length; v++) g[v] = g[v].input;
                      else i || m.sort(M);
                      if (((f = n ? g.concat(m) : m.concat(g)), o)) {
                        var C,
                          S = f;
                        for (f = [], v = 0; v < S.length; v++)
                          S[v] != C && f.push(S[v]), (C = S[v]);
                      }
                      e.replaceRange(f.join("\n"), u, h);
                    }
                  }
                  function M(e, t) {
                    var o;
                    ...
                    var a = i && d.exec(e),
                      s = i && d.exec(t);
                    return a
                      ? (a = parseInt((a[1] + a[2]).toLowerCase(), p)) -
                          (s = parseInt((s[1] + s[2]).toLowerCase(), p))
                      : e < t
                      ? -1
                      : 1;
                  }
                ...
                global: function (e, t) {
                  ...
                  if (n) {
                    ...
                    if (
                      (s.length &&
                        ((l = s[0]), (r = s.slice(1, s.length).join("/"))),
                      l)
                    )
                      try {
                        De(e, l, !0, !0);
                      } catch (t) {
                        return void Ne(e, "Invalid regex: " + l);
                      }
                    for (var c = Ee(e).getQuery(), u = [], h = i; h <= a; h++) {
                      var f = e.getLineHandle(h);
                      c.test(f.text) !== o && u.push(r ? f : f.text);
                    }
                    if (r) {
                      var d = 0;
                      !(function t() {
                        if (d < u.length) {
                          ...
                          var i = o + 1 + r;
                          Je.processCommand(e, i, { callback: t });
                        }
                      })();
                    } else Ne(e, u.join("\n"));
                  } else Ne(e, "Regular Expression missing from global");
                },
                substitute: function (e, t) {
                  ...
                  if (l.length)
                    (n = l[0]),
                      R("pcre") && "" !== n && (n = new RegExp(n).source),
                      void 0 !== (c = l[1]) &&
                        ((c = R("pcre")
                          ? (function (e) {
                              for (
                                var t = new k.StringStream(e), n = [];
                                !t.eol();
                  ...
                  if (void 0 !== (c = c || O.lastSubstituteReplacePart)) {
                    var f = Ee(e).getQuery(),
                      ...
                      (function (e, t, n, r, o, i, a, s, l) {
                        ...
                        function m(t) {
                          if ((t && t(), e.focus(), c)) {
                            e.setCursor(c);
                            var n = e.state.vim;
                            (n.exMode = !1), (n.lastHPos = n.lastHSPos = c.ch);
                          }
                          l && l();
                        }
                        if ((g(), !f))
                          return t
                            ...
                            : (d(), void (l && l()));
                        Ne(e, "No matches for " + a.source);
                      })(e, u, h, d, p, m, f, c, t.callback);
                  } else Ne(e, "No previous substitute regular expression");
                },
                redo: k.commands.redo,
                undo: k.commands.undo,
                write: function (e) {
                  k.commands.save ? k.commands.save(e) : e.save && e.save();
                },
                ...
                yank: function (e) {
                  var t = te(e.getCursor()).line,
                    n = e.getLine(t);
                  O.registerController.pushText("0", "yank", n, !0, !0);
                },
                delmarks: function (e, t) {
                  if (t.argString && le(t.argString))
                    for (
                      var n = e.state.vim,
                        r = new k.StringStream(le(t.argString));
                      !r.eol();
                      ...
                      if (r.match("-", !0)) {
                        ...
                        var a = i,
                          s = r.next();
                        if (!((m(a) && m(s)) || (v(a) && v(s))))
                          return void Ne(e, "Invalid argument: " + a + "-");
            ...
            function ze(e) {
              var t = e.state.vim,
                n = O.macroModeState,
                r = O.registerController.getRegister("."),
                o = n.isPlaying,
                i = n.lastInsertModeChanges;
              o || (e.off("change", Xe), k.off(e.getInputField(), "keydown", et)),
                !o &&
                  ...
                  (function (e) {
                    if (!e.isPlaying) {
                      var t = e.latestRegister,
                        n = O.registerController.getRegister(t);
                      n &&
            ...
            function Ge(e, t, n, r) {
              var o = O.registerController.getRegister(r);
              if (":" == r)
                return (
                  o.keyBuffer[0] && Je.processCommand(e, o.keyBuffer[0]),
                  void (n.isPlaying = !1)
                );
              var i = o.keyBuffer,
                a = 0;
              (n.isPlaying = !0),
                (n.replaySearchQueries = o.searchQueries.slice(0));
              for (var s = 0; s < i.length; s++)
                for (var l, c, u = i[s]; u; )
                  if (
                    ((c = (l = /<\w+-.+?>|<\w+>|./.exec(u))[0]),
                    (u = u.substring(l.index + c.length)),
                    j.handleKey(e, c, "macro"),
                    t.insertMode)
                  ) {
                    var h = o.insertModeChanges[a++].changes;
                    (O.macroModeState.lastInsertModeChanges.changes = h),
                      nt(e, h, 1),
                      ze(e);
                  }
              n.isPlaying = !1;
                    ...
                    if (
                      (t.visualMode && !e.somethingSelected()
                        ...
                        : t.visualMode ||
                          ...
                          ((t.visualMode = !0),
                          (t.visualLine = !1),
                          k.signal(e, "vim-mode-change", { mode: "visual" })),
                      t.visualMode)
                    ) {
                      var o = re(r, n) ? 0 : -1,
                        i = re(r, n) ? -1 : 0;
            ...
            function et(e) {
              var t = O.macroModeState.lastInsertModeChanges,
                n = k.keyName(e);
              n &&
                ((-1 == n.indexOf("Delete") && -1 == n.indexOf("Backspace")) ||
                  k.lookupKey(n, "vim-insert", function () {
                    return (
                      t.maybeReset && ((t.changes = []), (t.maybeReset = !1)),
                      t.changes.push(new Ze(n)),
                      !0
                    );
                  }));
            }
            function tt(e, t, n, r) {
              var o = O.macroModeState;
              o.isPlaying = !0;
              ...
              (t.inputState = a), t.insertMode && !r && ze(e), (o.isPlaying = !1);
            }
            function nt(e, t, n) {
              function r(t) {
                return "string" == typeof t ? k.commands[t](e) : t(e), !0;
              }
              var o = e.getCursor("head"),
                i = O.macroModeState.lastInsertModeChanges.visualBlock;
              i &&
                (he(e, o, i + 1),
                (n = e.listSelections().length),
                e.setCursor(o));
              for (var a = 0; a < n; a++) {
                i && e.setCursor(Y(o, a, 0));
                for (var s = 0; s < t.length; s++) {
                  var l = t[s];
                  if (l instanceof Ze) k.lookupKey(l.keyName, "vim-insert", r);
                  else if ("string" == typeof l)
                    (window.cm = e), e.replaceSelections(l);
                  else {
                    var c = e.getCursor(),
                      u = Y(c, 0, l[0].length);
                    e.replaceRange(l[0], c, u), e.setCursor(u);
                  }
                }
              }
              i && e.setCursor(Y(o, 0, 1));
            }
            return (
              (k.keyMap.vim = { attach: t, detach: e, call: n }),
            ...
            function e(t, n) {
              ...
              L(this, e),
                (this.closeInput = function () {
                  r.removeInputListeners(),
                    (r.input = null),
                    r.setSec(""),
                    r.editor && r.editor.focus();
                }),
                (this.clear = function () {
                  r.setInnerHtml_(r.node, "");
                }),
                (this.inputKeyUp = function (e) {
                  var t = r.input.options;
                  t && t.onKeyUp && t.onKeyUp(e, e.target.value, r.closeInput);
                }),
                (this.inputKeyInput = function (e) {
                  var t = r.input.options;
                  t && t.onKeyInput && t.onKeyUp(e, e.target.value, r.closeInput);
                }),
                (this.inputBlur = function () {
                  r.input.options.closeOnBlur && r.closeInput();
                }),
                (this.inputKeyDown = function (e) {
                  ...
                  (n &&
                    n.onKeyDown &&
                    n.onKeyDown(e, e.target.value, r.closeInput)) ||
                    ((27 === e.keyCode ||
                      (n && !1 !== n.closeOnEnter && 13 == e.keyCode)) &&
                      (r.input.node.blur(), e.stopPropagation(), r.closeInput()),
                    13 === e.keyCode &&
                      o &&
                      (e.stopPropagation(),
                      e.preventDefault(),
              ...
              (n = [
                {
                  ...
                  value: function (e) {
                    "visual" !== e.mode
                      ? this.setText("--".concat(e.mode.toUpperCase(), "--"))
                      : "linewise" === e.subMode
                ...
                },
                {
                  key: "setKeyBuffer",
                  value: function (e) {
                    this.keyInfoNode.textContent = e;
                  },
                },
                {
                  key: "setSec",
                  value: function (e, t, n) {
                    if (((this.notifNode.textContent = ""), void 0 === e))
                      return this.closeInput;
                    this.setInnerHtml_(this.secInfoNode, e);
                    var r = this.secInfoNode.querySelector("input");
                    return (
                      r &&
                        (r.focus(),
                        (this.input = { callback: t, options: n, node: r }),
                        n &&
                          (n.selectValueOnOpen && r.select(),
                ...
                },
                {
                  key: "setText",
                  value: function (e) {
                    this.modeInfoNode.textContent = e;
                  },
                },
                {
                  key: "toggleVisibility",
                  value: function (e) {
                    (this.node.style.display = e ? "block" : "none"),
                      this.input && this.removeInputListeners(),
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this.input.node;
                    e.addEventListener("keyup", this.inputKeyUp),
                      e.addEventListener("keydown", this.inputKeyDown),
                      e.addEventListener("input", this.inputKeyInput),
                      e.addEventListener("blur", this.inputBlur);
                  },
                },
                {
                  ...
                  value: function () {
                    if (this.input && this.input.node) {
                      var e = this.input.node;
                      e.removeEventListener("keyup", this.inputKeyUp),
                        e.removeEventListener("keydown", this.inputKeyDown),
                        e.removeEventListener("input", this.inputKeyInput),
                        e.removeEventListener("blur", this.inputBlur);
                    }
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    this.setInnerHtml_(n, e),
                      (this.notifNode.textContent = n.textContent),
                      (this.notifTimeout = setTimeout(function () {
                        t.notifNode.textContent = "";
                      }, 5e3));
                  },
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    t &&
                      (this.sanitizer
                        ? e.appendChild(this.sanitizer(t))
                        : e.appendChild(t));
                  },
                },
              ]) && T(t.prototype, n),
          ...
          function I(e) {
            ...
            var i = new n(t, e, r),
              a = "";
            return (
              o.on("vim-mode-change", function (e) {
                i.setMode(e);
              }),
              o.on("vim-keypress", function (e) {
                ":" === e ? (a = "") : (a += e), i.setKeyBuffer(a);
              }),
              o.on("vim-command-done", function () {
                (a = ""), i.setKeyBuffer(a);
              }),
              o.on("dispose", function () {
                i.toggleVisibility(!1), i.closeInput(), i.clear();
              }),
              i.toggleVisibility(!0),
              o.setStatusBar(i),
              o.attach(),
              o
            );
